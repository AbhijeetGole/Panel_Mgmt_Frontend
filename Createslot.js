...
const Createslot = () => {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      await Authservice.createSlot(slotId, panelName, startDate, endDate, startTime, endTime, skills, slotused, active).then(
        (data) => {
                ...
                <div className="card-body">
                  ...
                  <form onSubmit={submit}>
                    <div className="form-group mb-3">
                      ...
                      <input type="text" className="form-control" placeholder="Enter slot id"
                        value={slotId} onChange={(e) => setSlotId(e.target.value)}
                      />
                    </div>
                    <div className="form-group mb-3">
                    ...
                    <div className="d-grid gap-2 d-md-flex justify-content-md-end">
                      ...
                      <button className="btn btn-primary" onClick={diffToast} type="button" >Submit</button>
                    </div>
                  </form>
                </div>
              </div>
