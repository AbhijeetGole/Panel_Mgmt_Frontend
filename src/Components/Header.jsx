  ...
  return (
    <>
      ...
      <div className="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        ...
        <img  className="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 bg-dark flex-md-nowrap p-9 shadow" src={require('./../zensarlogo.jpg')}style={{'width':'5%','marginleft': '25%'}}  />
        <a className="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 bg-dark flex-md-nowrap p-0 shadow"  style={{'marginLeft':'-74%', 'fontSize': '30px'}}>ZenPanel</a>
